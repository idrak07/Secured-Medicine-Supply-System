      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
              <li class="nav-item active">
                  <a class="nav-link" href="/nbr">Home <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="/nbr/dgda/background">About</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="/nbr/dgda/pharmacies">Pharmacies</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="nbr/dgda/manufacturers">Manufacturers</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="/nbr/dgda/messages">Messages</a>
              </li>
