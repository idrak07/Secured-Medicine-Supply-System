...
<body>
  ...
  <main role="main" class="container">
      <div class=" text-center">
          <h3>Allopathic Retail Pharmacies </h3><br>
              ...
              <table  id="viewtable"> <!-- border="1" width="70%" align="center" -->
                <tr>
                  ...
                  <th id="viewTbaleData">Payable Tax</th>
                  <th id="viewTbaleData">tax Paying Status</th>
              ...
              @foreach($pharmacies as $data)
                <tr>
                  ...
                  <td id="viewTbaleData">{{$data->payAbleTax}}</td>
                  @if($data->taxStatus===0)
                  <td id="viewTbaleData" style="color: #38AF74 ;" align="center"><b>Clear</b></td>
                  @elseif($data->taxStatus===2)
                  <td id="viewTbaleData" style="color: EEE01E;" align="center"><b>On Warning</b></td>
                  @elseif($data->taxStatus===5)
                  <td id="viewTbaleData" style="color: red;" align="center"><b>Suspended</b></td>
                  @else
                  @endif
                  <td id="viewTbaleData">
                    <button class="btn btn-outline-success my-2 my-sm-0" type="submit"  ><a style="text-decoration: none" href="/nbr/dgda/pharmacies/allopathicRetailPharmacyProfile/{{$data->licenseNo}}"> View Profile</a></button>
                  </td>
              ...
              <p align="justify">
                See Reults
                @for ($i =1; $i <= 8900; $i=$i+100)
                <a href="http://127.0.0.1:8000/nbr/dgda/pharmacies/allopathicRetailPharmacyView/{{$i}}-{{($i+99)}}"> {{$i}}-{{($i+99)}} |</a>
                @endfor
                <a href="http://127.0.0.1:8000/nbr/dgda/pharmacies/allopathicRetailPharmacyView/8901-8961"> 8901-8961</a>
