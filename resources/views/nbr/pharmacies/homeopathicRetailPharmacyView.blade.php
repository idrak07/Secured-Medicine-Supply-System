          ...
          <h3>Homeopathic Retail Pharmacies</h3><br>
              ...
              @foreach($pharmacies as $data)
                <tr>
                  ...
                  @endif
                  <td id="viewTbaleData">
                    <button class="btn btn-outline-success my-2 my-sm-0" type="submit"  ><a style="text-decoration: none" href="/nbr/dgda/pharmacies/homeopathicRetailPharmacyProfile/{{$data->licenseNo}}">View Profile</a></button>
                  </td>
              ...
              <p align="justify">
                ...
                <a href="http://127.0.0.1:8000/nbr/dgda/pharmacies/homeopathicRetailPharmacyView/{{$i}}-{{($i+99)}}"> {{$i}}-{{($i+99)}} |</a>
                @endfor
                <a href="http://127.0.0.1:8000/nbr/dgda/pharmacies/homeopathicRetailPharmacyView/2401-2482"> 2401-2482</a>
