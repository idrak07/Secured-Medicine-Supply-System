...
<body>
          ...
          <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdown1">
                      ...
                      <li class="dropdown-item" ><a style="text-decoration:none;color: inherit;" href="/nbr/dgda/pharmacies/homeopathicRetailPharmacyView/1-100"><b>Homeopathic and Biochemic Retail Pharmacy</b></a></li>
  ...
  <main role="main" class="container">
    <p>Homeopathic Retail Pharmacy -><a href="/nbr/dgda/pharmacies/homeopathicRetailPharmacyProfile/{{$pharmacy->licenseNo}}">{{$pharmacy->pharmacyName}}</a></p><br>
            ...
            <form method = "POST" action = "">
                ...
                <center>
                  ...
                  <button type="button" class="btn btn-warning">
                    <a href="/nbr/dgda/pharmacies/homeopathicRetailPharmacyProfile/{{$pharmacy->licenseNo}}/makeWarning" style="text-decoration: none; color: white;">
                      Give Warning for Tax
                    </a>
                  </button>
                  <button type="button" class="btn btn-success">
                    <a href="/nbr/dgda/pharmacies/homeopathicRetailPharmacyProfile/{{$pharmacy->licenseNo}}/clear" style="text-decoration: none; color: white;" onclick="return confirm('Are You Sure You chcecked Document About Clearance ?')">
                      Clear Payment 
                    </a>
                  </button>
                  @elseif($pharmacy->taxStatus===2)
                  <button type="button" class="btn btn-danger">
                    <a href="/nbr/dgda/pharmacies/homeopathicRetailPharmacyProfile/{{$pharmacy->licenseNo}}/suspend" style="text-decoration: none; color: white;" onclick="return confirm('Are You Sure You want to suspend this Pharmacy ?')">
                      Suspend 
                    </a>
                  </button>
                  <button type="button" class="btn btn-success">
                  ...
                  <button type="button" class="btn btn-info" >
                    <a href="/nbr/dgda/pharmacies/homeopathicRetailPharmacyProfile/{{$pharmacy->licenseNo}}/getTaxList" style="text-decoration: none; color: white;" >
                      Get Tax List 
                    </a>
                  </button>
