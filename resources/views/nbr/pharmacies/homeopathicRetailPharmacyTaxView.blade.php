  ...
  <main role="main" class="container">
    <p>Homeopathic Retail Pharmacy -><a href="/dgda/pharmacies/homeopathicRetailPharmacyProfile/{{$pharmacy->licenseNo}}">{{$pharmacy->pharmacyName}}</a></p><br>
      <div class=" text-center">
            ...
            <h3 align="center">Tax Transactions : {{$pharmacy->licenseNo}}</h3>

              <br>
              <p align="right">
                 <button type="button" class="btn btn-info" >
                    <a  href="/nbr/dgda/pharmacies/homeopathicRetailPharmacyProfile/{{$pharmacy->licenseNo}}/getTaxList/download" style="text-decoration: none; color: white;" >
                      Download 
                    </a>
                </button>
              </p>
            ...
            <table  id="viewtable"> <!-- border="1" width="70%" align="center" -->
                <tr>
                  ...
                  <th id="viewTbaleData">Payment date</th>
                  <th id="viewTbaleData">Amount </th>
              ...
              @foreach($taxes as $data)
                <tr>
                  <td id="viewTbaleData">{{$pos++}}</td>
                  <td id="viewTbaleData">{{$data->transcDate}}</td>
                  <td id="viewTbaleData">{{$data->amount}}</td>
                </tr> 
              @endforeach
