          ...
          <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdown1">
                      ...
                      <li class="dropdown-item" ><a style="text-decoration:none;color: inherit;" href="/nbr/dgda/pharmacies/ayurvedic-retail-pharmacy-view/1-100"><b>Ayurvedic Retail Pharmacy</b></a></li>
...
\                      
  ...
  <main role="main" class="container">
      <div class=" text-center">
          <h3>Ayurvedic Retail Pharmacies </h3><br>
              ...
              @foreach($pharmacies as $data)
                <tr>
                  ...
                  @endif
                  <td id="viewTbaleData">
                    <button class="btn btn-outline-success my-2 my-sm-0" type="submit"  ><a style="text-decoration: none" href="/nbr/dgda/pharmacies/ayurvedicRetailPharmacyProfile/{{$data->licenseNo}}"> View Profile</a></button>
                  </td>
              ...
              <p align="justify">
                See Reults
                @for ($i =1; $i <400; $i=$i+100)
                <a href="http://127.0.0.1:8000/nbr/dgda/pharmacies/ayurvedicRetailPharmacyView/{{$i}}-{{($i+99)}}"> {{$i}}-{{($i+99)}} |</a>
                @endfor
                <a href="http://127.0.0.1:8000/nbr/dgda/pharmacies/ayurvedicRetailPharmacyView/401-416"> 401-416</a>
