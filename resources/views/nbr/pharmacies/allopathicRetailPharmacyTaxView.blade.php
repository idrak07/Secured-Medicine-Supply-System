...
<body>
  ...
  <main role="main" class="container">
    <p>Allopathic Retail Pharmacy -><a href="/nbr/dgda/pharmacies/allopathicRetailPharmacyProfile/{{$pharmacy->licenseNo}}">{{$pharmacy->pharmacyName}}</a></p><br>
      <div class=" text-center">
              ...
              <p align="right">
                 <button type="button" class="btn btn-info" >
                    <a  href="/nbr/dgda/pharmacies/allopathicRetailPharmacyProfile/{{$pharmacy->licenseNo}}/getTaxList/download" style="text-decoration: none; color: white;" >
                      Download 
                    </a>
                </button>
              </p>
