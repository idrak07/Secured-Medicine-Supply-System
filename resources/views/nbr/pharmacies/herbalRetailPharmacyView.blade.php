...
<body>
  ...
  <main role="main" class="container">
      <div class=" text-center">
          <h3>Herbal Retail Pharmacies </h3><br>
              ...
              @foreach($pharmacies as $data)
                <tr>
                  ...
                  @endif
                  <td id="viewTbaleData">
                    <button class="btn btn-outline-success my-2 my-sm-0" type="submit"  ><a style="text-decoration: none" href="/nbr/dgda/pharmacies/herbalRetailPharmacyProfile/{{$data->licenseNo}}"> View Profile</a></button>
                  </td>
