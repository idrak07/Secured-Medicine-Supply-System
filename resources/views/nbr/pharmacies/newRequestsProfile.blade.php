...
<body>
          ...
          <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdown1">
                      ...
                      <li class="dropdown-item active" ><a style="text-decoration:none;color: inherit;" href="/nbr/dgda/pharmacies/allopathicRetailPharmacyView/1-100"><b>Allopathic Retail Pharmacy</b></a></li>
                      ...
                      <li class="dropdown-item" ><a style="text-decoration:none;color: inherit;" href="/nbr/dgda/pharmacies/unaniRetailPharmacyView/1-100">Unani Retail Pharmacy</a></li>
                       <li class="dropdown-item" ><a style="text-decoration:none;color: inherit;" href="/nbr/nbr/dgda/pharmacies/herbalRetailPharmacyView/1-100">Herbal Retail Pharmacy</a></li>
  ...
  <main role="main" class="container">
    <p> Retail Pharmacy  Requests -><a href="/nbr/dgda/pharmacies/requests/{{$pharmacy->licenseNo}}">{{$pharmacy->pharmacyName}}</a></p><br>
      <div class=" text-center">
              ...
              <form method = "POST" action = "">
                ...
                <center>
                  ...
                  @if ($pharmacy->status === 2)

                  <button type="button" class="btn btn-success">
                    <a href="/nbr/dgda/pharmacies/requests/{{$pharmacy->licenseNo}}/verify-dgda" style="text-decoration: none; color: white;">
                  ...
                  <button type="button" class="btn btn-danger">
                    <a href="/nbr/dgda/pharmacies/requests/{{$pharmacy->licenseNo}}/verify-cancel" style="text-decoration: none; color: white;">
                      Cancel Request
                    </a>
                  </button>
                  @else
