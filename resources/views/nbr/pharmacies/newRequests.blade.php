...
<body>
  ...
  <div class="navbar navbar-expand-md navbar-dark bg-dark mb-4" role="navigation" width="100%">
      <a class="navbar-brand" href="/nbr">DGDA</a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle " id="dropdown1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> See Pharmacies</a>
                  <ul class="dropdown-menu" aria-labelledby="dropdown1">
                      ...
                      <li class="dropdown-item " ><a style="text-decoration:none;color: inherit;" href="/nbr/dgda/pharmacies/allopathicRetailPharmacyView/1-100">Allopathic Retail Pharmacy</a></li>
              ...
              <li class="nav-item active ">
                  <a class="nav-link" href="/nbr/dgda/pharmacies/requests"><b>New Requests</b></a>
              </li>
  ...
  <main role="main" class="container">
      <div class=" text-center">
          <h3>New Pharmacy Requests </h3><br>
              ...
              <table  id="viewtable"> <!-- border="1" width="70%" align="center" -->
                <tr>
                  ...
                  <th id="viewTbaleData">PharmacyType</th>
              ...
              @foreach($pharmacies as $data)
                <tr>
                  ...
                  @if ($data->pharmacyType === 1)
                  <td id="viewTbaleData">Allopathic Pharmacy</td>
                  @elseif ($data->pharmacyType === 2)
                  <td id="viewTbaleData">Ayurvedic Pharmacy</td>
                  @elseif ($data->pharmacyType === 3)
                  <td id="viewTbaleData">Unani Pharmacy</td>
                  @elseif ($data->pharmacyType === 4)
                  <td id="viewTbaleData">Herbal Pharmacy</td>
                  @else
                  <td id="viewTbaleData">Homeopathic Pharmacy</td>
                  @endif
                                    
                  <td id="viewTbaleData">{{$data->presentstatus}}</td>
                  <td id="viewTbaleData">
                    <button class="btn btn-outline-success my-2 my-sm-0" type="submit"  ><a style="text-decoration: none" href="/nbr/dgda/pharmacies/requests/{{$data->licenseNo}}">Details</a></button>
                  </td>
