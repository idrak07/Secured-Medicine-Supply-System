...
<body>
  ...
  <main role="main" class="container">
      <div class=" text-center">
          <h3>Unani Retail Pharmacies </h3><br>
              ...
              @foreach($pharmacies as $data)
                <tr>
                  ...
                  @endif
                  <td id="viewTbaleData">
                    <button class="btn btn-outline-success my-2 my-sm-0" type="submit"  ><a style="text-decoration: none" href="/nbr/dgda/pharmacies/unaniRetailPharmacyProfile/{{$data->licenseNo}}"> View Profile</a></button>
                  </td>
              ...
              <p align="justify">
                See Reults
                @for ($i =1; $i <600; $i=$i+100)
                <a href="http://127.0.0.1:8000/nbr/dgda/pharmacies/unaniRetailPharmacyView/{{$i}}-{{($i+99)}}"> {{$i}}-{{($i+99)}} |</a>
                @endfor
                <a href="http://127.0.0.1:8000/nbr/dgda/pharmacies/unaniRetailPharmacyView/601-688"> 601-688</a>
