...
<body style="background-color: #F0F0F0;">
	<form method="post" style="background: none">
		...
		<div id="logindiv">
			<table align="center">
				<tr>
					<td colspan="2" align="right"><h3 style="text-shadow: 2px 2px 4px #000000;"><a href="/index" style="text-decoration: none; color: inherit;">Welcome To 
						                                                       <br>Secured Medicine Supply System</a></h3></td>
				</tr>
				<tr>
