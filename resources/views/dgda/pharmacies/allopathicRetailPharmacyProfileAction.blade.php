...
<head>
    <meta charset="utf-8">
    <title>DGDA|Pharmacies|{{$pharmacy->pharmacyName}}</title>
...
<body>
          ...
          <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdown1">
                      <li class="dropdown-item active" ><a style="text-decoration:none;color: inherit;" href="/dgda/pharmacies/allopathicRetailPharmacyView/1-100"><b>Allopathic Retail Pharmacy</b></a></li>
                      ...
                      <li class="dropdown-item" ><a style="text-decoration:none;color: inherit;" href="/dgda/pharmacies/homeopathicRetailPharmacyView/1-100">Homeopathic and Biochemic Retail Pharmacy</a></li>
  ...
  <main role="main" class="container">
    <p>Allopathic Retail Pharmacy -><a href="/dgda/pharmacies/allopathicRetailPharmacyProfile/{{$pharmacy->licenseNo}}">{{$pharmacy->pharmacyName}}</a></p><br>
      <div class=" text-center">
              ...
              <form method = "POST" action = "">
                @csrf
                <input type="hidden" name="licenseNo" value="{{$pharmacy->licenseNo}}">
                <table id="setface" border="0" align="center" width="60%"  style=" font-family: Courier-New;" align="justify"> 
                    ...
                    <tr style="height: 50px">
                        <td id="labelSet"><b>Pharmacy Name </b></td>
                        <td>
                          <input id="rcorners" style="height:40px;font-size:14pt;" type="text" name="pharmacyName" size="40" value="{{$pharmacy->pharmacyName}}" >
                        </td>
                    </tr>
                    <tr style="height: 50px">
                        <td id="labelSet"><b>District Name </b></td>
                        <td>
                          <input id="rcorners" style="height:40px;font-size:14pt;" type="text" name="districtName" size="40" value="{{$pharmacy->districtName}}" >
                        </td>
                    </tr>
                    <tr style="height: 50px">
                        <td id="labelSet"><b>Upazilla Name </b></td>
                        <td>
                          <input id="rcorners" style="height:40px;font-size:14pt;" type="text" name="upazilaName" size="40" value="{{$pharmacy->upazilaName}}" >
                        </td>
                    </tr>
                    <tr style="height: 50px">
                        <td id="labelSet"><b>New License No </b></td>
                        <td>
                          <input id="rcorners" style="height:40px;font-size:14pt;" type="text" name="newLicense" size="40" value="{{$pharmacy->newLicense}}" >
                        </td>
                    </tr>
                    <tr style="height: 50px" align="left">
                        <td id="labelSet"><b>Date of Renewal </b></td>
                        <td> 
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input id="rcorners" style="height:40px;font-size:14pt;" type="date" name="dateOfRenewal" size="80" value="{{ \Carbon\Carbon::createFromDate($pharmacy->dateOfRenewal)->format('Y-m-d')}}" >
                        </td>
                    </tr>
                    <tr style="height: 50px">
                      <td id="labelSet"><b>Validity </b></td>
                      <td align="left">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input id="rcorners" style="height:40px;font-size:14pt;" type="date" class="" name="validUpto" size="40" required value ="{{ \Carbon\Carbon::createFromDate($pharmacy->validUpto)->format('Y-m-d')}}" >
                      </td>
                    </tr>
                </table>
                <br>
                <center><button type="button" class="btn btn-success"><a href="{{ URL::previous() }}" style="text-decoration: none; color: inherit;">Back</a></button>   <button type="button submit" class="btn btn-warning">Update Information </button>   <button type="button " class="btn btn-danger"><a href="/dgda/pharmacies/allopathicRetailPharmacyProfile/{{$pharmacy->licenseNo}}/{{$buttonText}}" style="text-decoration: none;color: inherit;">{{$buttonText}} Pharmacy</a> </button></center>
            </form>
