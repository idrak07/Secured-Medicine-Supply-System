...
<body>
          ...
          <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdown1">
                      ...
                      <li class="dropdown-item" ><a style="text-decoration:none;color: inherit;" href="/dgda/pharmacies/unaniRetailPharmacyView/1-100"><b>Unani Retail Pharmacy</b></a></li>
  ...
  <main role="main" class="container">
    <p>Unani Retail Pharmacy -><a href="/dgda/pharmacies/unaniRetailPharmacyProfile/{{$pharmacy->licenseNo}}">{{$pharmacy->pharmacyName}}</a></p><br>
