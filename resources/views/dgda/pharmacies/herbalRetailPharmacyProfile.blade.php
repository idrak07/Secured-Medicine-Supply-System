...
<body>
  ...
  <main role="main" class="container">
    <p>Herbal Retail Pharmacy -><a href="/dgda/pharmacies/herbalRetailPharmacyProfile/{{$pharmacy->licenseNo}}">{{$pharmacy->pharmacyName}}</a></p><br>
