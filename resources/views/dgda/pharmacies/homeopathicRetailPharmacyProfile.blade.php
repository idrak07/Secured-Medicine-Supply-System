    ...
    <p>Homeopathic Retail Pharmacy -><a href="/dgda/pharmacies/homeopathicRetailPharmacyProfile/{{$pharmacy->licenseNo}}">{{$pharmacy->pharmacyName}}</a></p><br>
      <div class=" text-center">
              ...
              <form method = "POST" action = "">
                ...
                <br>
                <center><button type="button" class="btn btn-success"><a href="{{ URL::previous() }}" style="text-decoration: none; color: inherit;">Back</a></button> <button type="button" class="btn btn-danger"><a href="/dgda/pharmacies/homeopathicRetailPharmacyProfile/{{$pharmacy->licenseNo}}/actions" style="text-decoration: none; color: white;">Take Actions</a></button></center>
            </form>
