...
<body>
              ...
              <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdown1">
                      ...
                      <li class="dropdown-item" ><a style="text-decoration:none;color: inherit;" href="/dgda/pharmacies/unaniRetailPharmacyView/1-100">Unani Retail Pharmacy</a></li>
                       <li class="dropdown-item" ><a style="text-decoration:none;color: inherit;" href="/dgda/pharmacies/herbalRetailPharmacyView/1-100"><b>Herbal Retail Pharmacy</b></a></li>
  ...
  <main role="main" class="container">
    <p>Herbal Retail Pharmacy -><a href="/dgda/pharmacies/allopathicRetailPharmacyProfile/{{$pharmacy->licenseNo}}">{{$pharmacy->pharmacyName}}</a></p><br>
