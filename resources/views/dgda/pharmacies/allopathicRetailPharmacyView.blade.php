          ...
          <h3>Allopathic Retail Pharmacies </h3><br>
              ...
              @foreach($pharmacies as $data)
                <tr>
                  ...
                  <td id="viewTbaleData">
                    <button class="btn btn-outline-success my-2 my-sm-0" type="submit"  ><a style="text-decoration: none" href="/dgda/pharmacies/allopathicRetailPharmacyProfile/{{$data->licenseNo}}"> View Profile</a></button>
                  </td>
              ...
              <p align="justify">
                ...
                <a href="http://127.0.0.1:8000/dgda/pharmacies/allopathicRetailPharmacyView/{{$i}}-{{($i+99)}}"> {{$i}}-{{($i+99)}} |</a>
                @endfor
                <a href="http://127.0.0.1:8000/dgda/pharmacies/allopathicRetailPharmacyView/8901-8961"> 8901-8961</a>
