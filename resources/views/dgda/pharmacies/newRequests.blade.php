          ...
          <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdown1">
                      ...
                      <li class="dropdown-item " ><a style="text-decoration:none;color: inherit;" href="/dgda/pharmacies/allopathicRetailPharmacyView/1-100">Allopathic Retail Pharmacy</a></li>
              ...
              <li class="nav-item active ">
                  <a class="nav-link" href="/dgda/pharmacies/requests"><b>New Requests</b></a>
              </li>
          ...
          <h3>New Pharmacy Requests </h3><br>
              ...
              @foreach($pharmacies as $data)
                <tr>
                  ...
                  <td id="viewTbaleData">
                    <button class="btn btn-outline-success my-2 my-sm-0" type="submit"  ><a style="text-decoration: none" href="/dgda/pharmacies/requests/{{$data->licenseNo}}">Details</a></button>
                  </td>
