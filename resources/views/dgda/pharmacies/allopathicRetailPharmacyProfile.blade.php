  ...
  <main role="main" class="container">
    <p>Allopathic Retail Pharmacy -><a href="/dgda/pharmacies/allopathicRetailPharmacyProfile/{{$pharmacy->licenseNo}}">{{$pharmacy->pharmacyName}}</a></p><br>
      <div class=" text-center">
              ...
              -->
                <!-- <tr>
                  <td id="viewTbaleData">{{$pharmacy->sl}}</td>
                  <td id="viewTbaleData">{{$pharmacy->pharmacyName}}</td>
                  <td id="viewTbaleData">{{$pharmacy->districtName}}</td>
                  <td id="viewTbaleData">{{$pharmacy->upazilaName}}</td>
                  <td id="viewTbaleData">{{$pharmacy->licenseNo}}</td>
                  <td id="viewTbaleData">{{$pharmacy->newLicense}}</td>
                  <td id="viewTbaleData">{{$pharmacy->dateOfRenewal}}</td>
                  <td id="viewTbaleData">{{$pharmacy->validUpto}}</td>
              ...
              <form method = "POST" action = "">
                <table id="setface" border="0" align="center" width="60%"  style=" font-family: Courier-New;" align="justify"> 
                    ...
                    <tr style="height: 40px">
                        <td><b>New License No </b></td>
                        <td style="color:#0f798a;"><b>{{$pharmacy->newLicense}}</b></td>
                    </tr>
                    <tr style="height: 40px">
                        <td><b>Date of Renewal </b></td>
                        <td style="color:#0f798a;"><b>{{$pharmacy->dateOfRenewal}}</b></td>
                    </tr>
                    <tr style="height: 40px">
                        <td><b>Validity </b></td>
