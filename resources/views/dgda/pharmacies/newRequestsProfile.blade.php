...
<body>
  ...
  <main role="main" class="container">
    <p> Retail Pharmacy  Requests -><a href="/dgda/pharmacies/allopathicRetailPharmacyProfile/{{$pharmacy->licenseNo}}">{{$pharmacy->pharmacyName}}</a></p><br>
      <div class=" text-center">
              ...
              <form method = "POST" action = "">
                <table id="setface" border="0" align="center" width="60%"  style=" font-family: Courier-New;" align="justify"> 
                    ...
                    <tr style="height: 40px">
                        <td><b>Pharmacy Type</b></td>

                        @if ($pharmacy->pharmacyType == 1)
                        <td style="color:#0f798a;"><b>Allopathic Pharmacy</b></td>
                        @elseif ($pharmacy->pharmacyType == 2)
                        <td style="color:#0f798a;"><b>Ayurvedic Pharmacy</b></td>
                        @elseif ($pharmacy->pharmacyType == 3)
                        <td style="color:#0f798a;"><b>Unani Pharmacy</b></td>
                        @elseif ($pharmacy->pharmacyType == 4)
                        <td style="color:#0f798a;"><b>Herbal Pharmacy</b></td>
                        @elseif ($pharmacy->pharmacyType == 5)
                        <td style="color:#0f798a;"><b>Homeopathic Pharmacy</b></td>
                        @else
                        <td style="color:#0f798a;"><b>None Pharmacy</b></td>
                        @endif
                    </tr>
                    <tr style="height: 40px">
                    ...
                    <tr style="height: 40px">
                        <td><b>Address </b></td>
                        <td style="color:#0f798a;"><b>{{$pharmacy->address}}</b></td>
                    </tr>
                    ...
                    <tr style="height: 40px">
                        ...
                        <td style="color:#0f798a;"><b>{{$pharmacy->regNo}}</b></td>
                    </tr>
                    <tr style="height: 40px">
                        <td><b>Contact No </b></td>
                        <td style="color:#0f798a;"><b>+880{{$pharmacy->contactNo}}</b></td>
                    </tr>
                    <tr style="height: 40px">
                        <td><b>Pharmacist Name </b></td>
                        <td style="color:#0f798a;"><b>{{$pharmacy->pharmacistName}}</b></td>
                    </tr>
                    <tr style="height: 40px">
                        <td><b>Proprietor Name </b></td>
                        <td style="color:#0f798a;"><b>{{$pharmacy->proprietorName}}</b></td>
                    </tr>
                    <tr style="height: 40px">
                        <td><b>National Id </b></td>
                        <td style="color:#0f798a;"><b>{{$pharmacy->nid}}</b></td>
                    </tr>
                    <tr style="height: 40px">
                        <td><b> Request Status </b></td>
                        <td style="color:#0f798a;"><b>{{$pharmacy->presentstatus}}</b></td>
                    </tr>
                ...
                <center>
                  ...
                  <button type="button" class="btn btn-success">
                    <a href="/dgda/pharmacies/requests/{{$pharmacy->licenseNo}}/verify-nbr" style="text-decoration: none; color: white;">
                      Verify To NBR
                    </a>
                  </button>
                  @elseif($pharmacy->status === 3)
                  <button type="button" class="btn btn-success">
                    <a href="/dgda/pharmacies/requests/{{$pharmacy->licenseNo}}/verify-confirm" style="text-decoration: none; color: white;">
                      Verify Confiramtion
                    </a>
                  </button>
                  @else
                  ...
                  <button type="button" class="btn btn-danger">
                    <a href="/dgda/pharmacies/requests/{{$pharmacy->licenseNo}}/verify-cancel" style="text-decoration: none; color: white;">
                      cancel Request
                    </a>
                  </button>
                  @else
