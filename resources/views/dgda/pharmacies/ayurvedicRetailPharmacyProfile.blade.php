...
<body>
  ...
  <main role="main" class="container">
    <p>Ayurvedic Retail Pharmacy -><a href="/dgda/pharmacies/ayurvedicRetailPharmacyProfile/{{$pharmacy->licenseNo}}">{{$pharmacy->pharmacyName}}</a></p><br>
