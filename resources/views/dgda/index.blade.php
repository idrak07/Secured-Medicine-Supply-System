  ...
  <div class="navbar navbar-expand-md navbar-dark bg-dark mb-4" role="navigation" width="100%">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="/dgda/background">About</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="/dgda/pharmacies">Pharmacies</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="/dgda/manufacturers">Manufacturers</a>
              </li>
              <li class="nav-item ">
                  <a class="nav-link disabled" href="/dgda/products">Products</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link disabled" href="/dgda/doctors">Doctors</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link disabled" href="/dgda/medical-devices">Medical-Devices</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link disabled" href="/dgda/notifications">Notifications</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link disabled" href="/dgda/messages">Messages</a>
              </li>
