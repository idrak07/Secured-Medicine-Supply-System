...
<head>
    <meta charset="utf-8">
    <title>SMSS|Sign-Up|Pharmacy</title>
...
<body>
  ...
  <main role="main" class="container">
      <div class=" text-center">
              ...
              <h3 align="center">Pharmacy Sign-up !</h3>
              ...
              <form method = "POST" action = "">
                ...
                <table id="setface" border="0" align="center" width="60%"  style=" font-family: Courier-New;" align="justify"> 
                    ...
                    <tr style="height: 50px">
                        <td id="labelSet"><b>Pharmacy Type  </b></td>
                        <td align="left">
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <select name="pharmacyType" id="rcorners" style="color: inherit; height: 30px; size: 35px;">
                            <option value="1">Allopathic Pharmacy</option>
                            <option value="2">Ayurvdiec Pharmacy</option>
                            <option value="3">Unani Pharmacy</option>
                            <option value="4">herbal Pharmacy</option>
                            <option value="5">Homeopathic & Biochemic Pharmacy</option>
                    ...
                    <tr style="height: 50px">
                        ...
                        <td>
                          <input id="rcorners" style="height:30px;font-size:12pt;" type="text" name="pharmacyName" size="35" placeholder="According to Trade License" >
                        </td>
                    </tr>
                    <tr style="height: 50px">
                    ...
                    <tr style="height: 50px">
                        ...
                        <td>
                          <input id="rcorners" style="height:30px;font-size:12pt;" type="text" name="upazilaName" size="35" placeholder="Write location Upazilla" >
                        </td>
                    </tr>
                    <tr style="height: 50px">
                    ...
                    <tr style="height: 50px">
                      <td colspan="2">
                        <br><br>
                    <font style="font-size: 18pt; color: #09194A;">Personal Information</font><br>
                      </td>
                    </tr>
                    <tr style="height: 50px">
                        <td id="labelSet"><b>Pharmacist Name </b></td>
                        <td>
                          <input id="rcorners" style="height:30px;font-size:12pt;" type="text" name="pharmacistName" size="35" placeholder="" >
                        </td>
                    </tr>
                    <tr style="height: 50px">
                        <td id="labelSet"><b>Proprietor Name </b></td>
                        <td>
                          <input id="rcorners" style="height:30px;font-size:12pt;" type="text" name="proprietorName" size="35" placeholder="" >
                        </td>
                    </tr>
                    <tr style="height: 50px">
                        <td id="labelSet"><b>National Id</b></td>
                        <td>
                          <input id="rcorners" style="height:30px;font-size:12pt;" type="text" name="nid" size="35" placeholder="" >
                        </td>
                    </tr>
                    <tr style="height: 50px">
                        <td id="labelSet"><b>Address</b></td>
                        <td>
                          <input id="rcorners" style="height:30px;font-size:12pt;" type="text" name="address" size="35" placeholder=" Enter Pharmacy address" >
                        </td>
                    </tr>
                </table>
                <br>
