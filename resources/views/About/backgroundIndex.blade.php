...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item active">
                  <a class="nav-link" href="/index/background">Backround<span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="/index/biography">Biography</a>
              </li>
  ...
  <main role="main" class="container">
      <div class=" text-center">
          <h1 align="left">Background<br><br> </h1>
